...
- [x] Persistent owned cart and count
- [x] Server-revalidated checkout, address, coupon, totals, and provisional payments
- [x] Transactional snapshots and duplicate-submission protection
- [x] Atomic stock decrement and movement ledger
