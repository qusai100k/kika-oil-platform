...
- [x] Registration, login, logout architecture and UI
- [x] Secure password recovery and expiration
- [x] Protected account routes
- [x] Profile and phone update
- [x] Address create/default/delete with ownership checks
- [x] Password change with current-password verification
- [x] Server-controlled CUSTOMER role
